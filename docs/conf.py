...
myst_url_schemes = {
    ...
    "gh-issue": {
        "url": "https://github.com/radionets-project/pyvisgrid/issue/{{path}}#{{fragment}}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
}
...
json_url = "https://pyvisgrid.readthedocs.io/en/latest/_static/switcher.json"
...
html_theme_options = {
    "github_url": "https://github.com/radionets-project/pyvisgrid",
    ...
    "announcement": """
        <p>pyvisgrid is not stable yet, so expect large and rapid
